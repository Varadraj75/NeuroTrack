...
class TherapyTypeEntityMapper extends ClassMapperBase<TherapyTypeEntity> {
  ...
  static const Field<TherapyTypeEntity, String> _f$therapyId = Field(
    'therapyId',
    _$therapyId,
    key: r'id',
  );
  static DateTime _$createdAt(TherapyTypeEntity v) => v.createdAt;
  static const Field<TherapyTypeEntity, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  ...
  static const Field<TherapyTypeEntity, String> _f$description = Field(
    'description',
    _$description,
  );
...
mixin TherapyTypeEntityMappable {
  ...
  get copyWith =>
      _TherapyTypeEntityCopyWithImpl<TherapyTypeEntity, TherapyTypeEntity>(
        this as TherapyTypeEntity,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return TherapyTypeEntityMapper.ensureInitialized().stringifyValue(
      this as TherapyTypeEntity,
    );
  }
  ...
  bool operator ==(Object other) {
    return TherapyTypeEntityMapper.ensureInitialized().equalsValue(
      this as TherapyTypeEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TherapyTypeEntityMapper.ensureInitialized().hashValue(
      this as TherapyTypeEntity,
    );
  }
}
...
extension TherapyTypeEntityValueCopy<$R, $Out>
  ...
  get $asTherapyTypeEntity => $base.as(
    (v, t, t2) => _TherapyTypeEntityCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class TherapyTypeEntityCopyWith<
  $R,
  $In extends TherapyTypeEntity,
  $Out
>
