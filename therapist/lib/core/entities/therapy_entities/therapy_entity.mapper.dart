...
mixin TherapyEntityMappable {
  String toJson() {
    return TherapyEntityMapper.ensureInitialized().encodeJson<TherapyEntity>(
      this as TherapyEntity,
    );
  }

  Map<String, dynamic> toMap() {
    return TherapyEntityMapper.ensureInitialized().encodeMap<TherapyEntity>(
      this as TherapyEntity,
    );
  }
  ...
  @override
  String toString() {
    return TherapyEntityMapper.ensureInitialized().stringifyValue(
      this as TherapyEntity,
    );
  }
  ...
  bool operator ==(Object other) {
    return TherapyEntityMapper.ensureInitialized().equalsValue(
      this as TherapyEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TherapyEntityMapper.ensureInitialized().hashValue(
      this as TherapyEntity,
    );
  }
}
