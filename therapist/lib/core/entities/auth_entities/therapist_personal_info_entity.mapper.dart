...
class TherapistPersonalInfoEntityMapper
  ...
  static TherapistPersonalInfoEntityMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = TherapistPersonalInfoEntityMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<TherapistPersonalInfoEntity, String> _f$id = Field(
    'id',
    _$id,
  );
  static String _$name(TherapistPersonalInfoEntity v) => v.name;
  static const Field<TherapistPersonalInfoEntity, String> _f$name = Field(
    'name',
    _$name,
  );
  static int _$age(TherapistPersonalInfoEntity v) => v.age;
  static const Field<TherapistPersonalInfoEntity, int> _f$age = Field(
    'age',
    _$age,
  );
  static String _$gender(TherapistPersonalInfoEntity v) => v.gender;
  static const Field<TherapistPersonalInfoEntity, String> _f$gender = Field(
    'gender',
    _$gender,
  );
  static int _$professionId(TherapistPersonalInfoEntity v) => v.professionId;
  static const Field<TherapistPersonalInfoEntity, int> _f$professionId = Field(
    'professionId',
    _$professionId,
    key: r'profession_id',
  );
...
mixin TherapistPersonalInfoEntityMappable {
  ...
  TherapistPersonalInfoEntityCopyWith<
  ...
  @override
  String toString() {
    return TherapistPersonalInfoEntityMapper.ensureInitialized().stringifyValue(
      this as TherapistPersonalInfoEntity,
    );
  }
  ...
  bool operator ==(Object other) {
    return TherapistPersonalInfoEntityMapper.ensureInitialized().equalsValue(
      this as TherapistPersonalInfoEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TherapistPersonalInfoEntityMapper.ensureInitialized().hashValue(
      this as TherapistPersonalInfoEntity,
    );
  }
}
...
extension TherapistPersonalInfoEntityValueCopy<$R, $Out>
  ...
  get $asTherapistPersonalInfoEntity => $base.as(
    (v, t, t2) => _TherapistPersonalInfoEntityCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _TherapistPersonalInfoEntityCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _TherapistPersonalInfoEntityCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
