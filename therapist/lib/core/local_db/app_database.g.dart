...
class $SessionsTable extends Sessions
    with TableInfo<$SessionsTable, TherapistSessionDbEntity> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
      Insertable<TherapistSessionDbEntity> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TherapistSessionDbEntity map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TherapistSessionDbEntity(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      therapistId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}therapist_id'])!,
...
class TherapistSessionDbEntity extends DataClass
    implements Insertable<TherapistSessionDbEntity> {
  final String id;
  final String therapistId;
  final String patientId;
  ...
  const TherapistSessionDbEntity(
      {required this.id,
      required this.therapistId,
      required this.patientId,
  ...
  factory TherapistSessionDbEntity.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TherapistSessionDbEntity(
      id: serializer.fromJson<String>(json['id']),
  ...
  TherapistSessionDbEntity copyWith(
          {String? id,
          String? therapistId,
          String? patientId,
  ...
  TherapistSessionDbEntity copyWithCompanion(SessionsCompanion data) {
    return TherapistSessionDbEntity(
      id: data.id.present ? data.id.value : this.id,
      therapistId:
          data.therapistId.present ? data.therapistId.value : this.therapistId,
  ...
  @override
  String toString() {
    return (StringBuffer('TherapistSessionDbEntity(')
          ..write('id: $id, ')
          ..write('therapistId: $therapistId, ')
          ..write('patientId: $patientId, ')
  ...
  @override
  int get hashCode => Object.hash(id, therapistId, patientId, scheduledTime,
      status, notes, durationMinutes);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TherapistSessionDbEntity &&
          other.id == this.id &&
          other.therapistId == this.therapistId &&
          other.patientId == this.patientId &&
...
class SessionsCompanion extends UpdateCompanion<TherapistSessionDbEntity> {
  final Value<String> id;
  final Value<String> therapistId;
  final Value<String> patientId;
  ...
  SessionsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
        ...
        status = Value(status),
        durationMinutes = Value(durationMinutes);
  static Insertable<TherapistSessionDbEntity> custom({
    Expression<String>? id,
    Expression<String>? therapistId,
    Expression<String>? patientId,
...
class $TherapyGoalsTable extends TherapyGoals
    with TableInfo<$TherapyGoalsTable, GoalDbEntity> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TherapyGoalsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumn<String> status = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, patientId, description, status];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'therapy_goals';
  @override
  VerificationContext validateIntegrity(Insertable<GoalDbEntity> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  GoalDbEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GoalDbEntity(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
  ...
  @override
  $TherapyGoalsTable createAlias(String alias) {
    return $TherapyGoalsTable(attachedDatabase, alias);
  }
}

class GoalDbEntity extends DataClass implements Insertable<GoalDbEntity> {
  final String id;
  final String patientId;
  ...
  TherapyGoalsCompanion toCompanion(bool nullToAbsent) {
    return TherapyGoalsCompanion(
      id: Value(id),
      patientId: Value(patientId),
  ...
  factory GoalDbEntity.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return GoalDbEntity(
      id: serializer.fromJson<String>(json['id']),
  ...
  GoalDbEntity copyWithCompanion(TherapyGoalsCompanion data) {
    return GoalDbEntity(
      id: data.id.present ? data.id.value : this.id,
      patientId: data.patientId.present ? data.patientId.value : this.patientId,
      description:
  ...
  @override
  String toString() {
    return (StringBuffer('GoalDbEntity(')
          ..write('id: $id, ')
          ..write('patientId: $patientId, ')
  ...
  @override
  int get hashCode => Object.hash(id, patientId, description, status);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is GoalDbEntity &&
          other.id == this.id &&
          other.patientId == this.patientId &&
...
class TherapyGoalsCompanion extends UpdateCompanion<GoalDbEntity> {
  final Value<String> id;
  final Value<String> patientId;
  final Value<String> description;
  final Value<String> status;
  final Value<int> rowid;
  const TherapyGoalsCompanion({
    this.id = const Value.absent(),
    this.patientId = const Value.absent(),
  ...
  TherapyGoalsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
        ...
        description = Value(description),
        status = Value(status);
  static Insertable<GoalDbEntity> custom({
    Expression<String>? id,
    Expression<String>? patientId,
  ...
  TherapyGoalsCompanion copyWith(
      {Value<String>? id,
      Value<String>? patientId,
  ...
  @override
  String toString() {
    return (StringBuffer('TherapyGoalsCompanion(')
          ..write('id: $id, ')
          ..write('patientId: $patientId, ')
          ..write('description: $description, ')
          ..write('status: $status, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $TherapyGoalsTable therapyGoals = $TherapyGoalsTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [therapists, patients, consultationRequests, sessions, therapyGoals];
}
...
class $$SessionsTableTableManager extends RootTableManager<
    ...
    (
      TherapistSessionDbEntity,
      BaseReferences<_$AppDatabase, $SessionsTable, TherapistSessionDbEntity>
    ),
    TherapistSessionDbEntity,
    PrefetchHooks Function()> {
...
typedef $$SessionsTableProcessedTableManager = ProcessedTableManager<
    ...
    TherapistSessionDbEntity,
    PrefetchHooks Function()>;
typedef $$TherapyGoalsTableCreateCompanionBuilder = TherapyGoalsCompanion
    Function({
  required String id,
  required String patientId,
  required String description,
...
typedef $$TherapyGoalsTableUpdateCompanionBuilder = TherapyGoalsCompanion
    Function({
  Value<String> id,
  Value<String> patientId,
  Value<String> description,
...
class $$TherapyGoalsTableFilterComposer
    extends Composer<_$AppDatabase, $TherapyGoalsTable> {
  $$TherapyGoalsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TherapyGoalsTableOrderingComposer
    extends Composer<_$AppDatabase, $TherapyGoalsTable> {
  $$TherapyGoalsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TherapyGoalsTableAnnotationComposer
    extends Composer<_$AppDatabase, $TherapyGoalsTable> {
  $$TherapyGoalsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TherapyGoalsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $TherapyGoalsTable,
    GoalDbEntity,
    $$TherapyGoalsTableFilterComposer,
    $$TherapyGoalsTableOrderingComposer,
    $$TherapyGoalsTableAnnotationComposer,
    $$TherapyGoalsTableCreateCompanionBuilder,
    $$TherapyGoalsTableUpdateCompanionBuilder,
    (
      GoalDbEntity,
      BaseReferences<_$AppDatabase, $TherapyGoalsTable, GoalDbEntity>
    ),
    GoalDbEntity,
    PrefetchHooks Function()> {
  $$TherapyGoalsTableTableManager(_$AppDatabase db, $TherapyGoalsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$TherapyGoalsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$TherapyGoalsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$TherapyGoalsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
            Value<String> patientId = const Value.absent(),
...
typedef $$TherapyGoalsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $TherapyGoalsTable,
    GoalDbEntity,
    $$TherapyGoalsTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$TherapyGoalsTableTableManager get therapyGoals =>
      $$TherapyGoalsTableTableManager(_db, _db.therapyGoals);
}
