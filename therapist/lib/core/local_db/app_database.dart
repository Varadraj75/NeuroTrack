...
@DataClassName('TherapistSessionDbEntity')
...
@DataClassName('GoalDbEntity')
class TherapyGoals extends Table {
  TextColumn get id => text()();
  TextColumn get patientId => text()();
  TextColumn get description => text()();
  TextColumn get status => text()(); // e.g. "active", "completed"

  @override
  Set<Column> get primaryKey => {id};
}

@DriftDatabase(tables: [Therapists, Patients, ConsultationRequests, Sessions, TherapyGoals])
...
LazyDatabase _openConnection() {
  return LazyDatabase(() async {
    ...
    final file = File(p.join(dbFolder.path, 'therapist_db.sqlite'));
