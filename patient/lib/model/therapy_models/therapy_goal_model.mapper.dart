...
class TherapyGoalModelMapper extends ClassMapperBase<TherapyGoalModel> {
  ...
  static const Field<TherapyGoalModel, int> _f$duration = Field(
    'duration',
    _$duration,
    opt: true,
  );
  static String? _$therapistName(TherapyGoalModel v) => v.therapistName;
  static const Field<TherapyGoalModel, String> _f$therapistName = Field(
    'therapistName',
    _$therapistName,
    key: r'name',
    opt: true,
  ...
  static const Field<TherapyGoalModel, String> _f$therapistPhone = Field(
    'therapistPhone',
    _$therapistPhone,
    key: r'phone',
    opt: true,
  ...
  static const Field<TherapyGoalModel, String> _f$therapistEmail = Field(
    'therapistEmail',
    _$therapistEmail,
    key: r'email',
    opt: true,
  ...
  static const Field<TherapyGoalModel, String> _f$therapyType = Field(
    'therapyType',
    _$therapyType,
    key: r'therapy_type',
    opt: true,
  ...
  static const Field<TherapyGoalModel, int> _f$therapyMode = Field(
    'therapyMode',
    _$therapyMode,
    key: r'therapy_mode',
    opt: true,
  ...
  static const Field<TherapyGoalModel, String> _f$specialization = Field(
    'specialization',
    _$specialization,
    opt: true,
  );
