...
class TherapistModelMapper extends ClassMapperBase<TherapistModel> {
  ...
  static const Field<TherapistModel, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  ...
  static const Field<TherapistModel, String> _f$clinicId = Field(
    'clinicId',
    _$clinicId,
    key: r'clinic_id',
  );
  static bool _$approved(TherapistModel v) => v.approved;
  static const Field<TherapistModel, bool> _f$approved = Field(
    'approved',
    _$approved,
  );
  static String _$specialisation(TherapistModel v) => v.specialisation;
  static const Field<TherapistModel, String> _f$specialisation = Field(
    'specialisation',
    _$specialisation,
  );
  static String _$gender(TherapistModel v) => v.gender;
  static const Field<TherapistModel, String> _f$gender = Field(
    'gender',
    _$gender,
  );
  static List<String> _$offeredTherapies(TherapistModel v) =>
      v.offeredTherapies;
  static const Field<TherapistModel, List<String>> _f$offeredTherapies = Field(
    'offeredTherapies',
    _$offeredTherapies,
...
mixin TherapistModelMappable {
  String toJson() {
    return TherapistModelMapper.ensureInitialized().encodeJson<TherapistModel>(
      this as TherapistModel,
    );
  }

  Map<String, dynamic> toMap() {
    return TherapistModelMapper.ensureInitialized().encodeMap<TherapistModel>(
      this as TherapistModel,
    );
  }

  TherapistModelCopyWith<TherapistModel, TherapistModel, TherapistModel>
  get copyWith => _TherapistModelCopyWithImpl<TherapistModel, TherapistModel>(
    this as TherapistModel,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return TherapistModelMapper.ensureInitialized().stringifyValue(
      this as TherapistModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return TherapistModelMapper.ensureInitialized().equalsValue(
      this as TherapistModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TherapistModelMapper.ensureInitialized().hashValue(
      this as TherapistModel,
    );
  }
}
