...
class PersonalInfoModelMapper extends ClassMapperBase<PersonalInfoModel> {
  ...
  static const Field<PersonalInfoModel, String> _f$patientId = Field(
    'patientId',
    _$patientId,
  );
  static String _$patientName(PersonalInfoModel v) => v.patientName;
  static const Field<PersonalInfoModel, String> _f$patientName = Field(
    'patientName',
    _$patientName,
  );
  ...
  static const Field<PersonalInfoModel, bool> _f$isAdult = Field(
    'isAdult',
    _$isAdult,
  );
  static String _$phoneNo(PersonalInfoModel v) => v.phoneNo;
  static const Field<PersonalInfoModel, String> _f$phoneNo = Field(
    'phoneNo',
    _$phoneNo,
  );
  static String _$email(PersonalInfoModel v) => v.email;
  static const Field<PersonalInfoModel, String> _f$email = Field(
    'email',
    _$email,
  );
  static String _$guardianName(PersonalInfoModel v) => v.guardianName;
  static const Field<PersonalInfoModel, String> _f$guardianName = Field(
    'guardianName',
    _$guardianName,
  );
  static String _$guardianRelation(PersonalInfoModel v) => v.guardianRelation;
  static const Field<PersonalInfoModel, String> _f$guardianRelation = Field(
    'guardianRelation',
    _$guardianRelation,
  );
  static String _$country(PersonalInfoModel v) => v.country;
  static const Field<PersonalInfoModel, String> _f$country = Field(
    'country',
    _$country,
  );
  static String _$gender(PersonalInfoModel v) => v.gender;
  static const Field<PersonalInfoModel, String> _f$gender = Field(
    'gender',
    _$gender,
  );
...
mixin PersonalInfoModelMappable {
  ...
  get copyWith =>
      _PersonalInfoModelCopyWithImpl<PersonalInfoModel, PersonalInfoModel>(
        this as PersonalInfoModel,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PersonalInfoModelMapper.ensureInitialized().stringifyValue(
      this as PersonalInfoModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return PersonalInfoModelMapper.ensureInitialized().equalsValue(
      this as PersonalInfoModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PersonalInfoModelMapper.ensureInitialized().hashValue(
      this as PersonalInfoModel,
    );
  }
}
...
extension PersonalInfoModelValueCopy<$R, $Out>
  ...
  get $asPersonalInfoModel => $base.as(
    (v, t, t2) => _PersonalInfoModelCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class PersonalInfoModelCopyWith<
  $R,
  $In extends PersonalInfoModel,
  $Out
>
