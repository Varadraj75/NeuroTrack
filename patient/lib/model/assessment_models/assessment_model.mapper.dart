...
class AssessmentModelMapper extends ClassMapperBase<AssessmentModel> {
  ...
  static const Field<AssessmentModel, String> _f$assessmentId = Field(
    'assessmentId',
    _$assessmentId,
    key: r'id',
  );
  static String _$createdAt(AssessmentModel v) => v.createdAt;
  static const Field<AssessmentModel, String> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  ...
  static const Field<AssessmentModel, String> _f$description = Field(
    'description',
    _$description,
  );
  static String _$category(AssessmentModel v) => v.category;
  static const Field<AssessmentModel, String> _f$category = Field(
    'category',
    _$category,
  );
  static int _$cutoffScore(AssessmentModel v) => v.cutoffScore;
  static const Field<AssessmentModel, int> _f$cutoffScore = Field(
    'cutoffScore',
    _$cutoffScore,
    key: r'cutoff_score',
  );
  ...
  static const Field<AssessmentModel, String> _f$imageUrl = Field(
    'imageUrl',
    _$imageUrl,
    key: r'image_url',
  );
...
mixin AssessmentModelMappable {
  ...
  Map<String, dynamic> toMap() {
    return AssessmentModelMapper.ensureInitialized().encodeMap<AssessmentModel>(
      this as AssessmentModel,
    );
  }
  ...
  @override
  String toString() {
    return AssessmentModelMapper.ensureInitialized().stringifyValue(
      this as AssessmentModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return AssessmentModelMapper.ensureInitialized().equalsValue(
      this as AssessmentModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AssessmentModelMapper.ensureInitialized().hashValue(
      this as AssessmentModel,
    );
  }
}
...
abstract class AssessmentModelCopyWith<$R, $In extends AssessmentModel, $Out>
  ...
  ListCopyWith<
    ...
    AssessmentQuestionModelCopyWith<
      $R,
      AssessmentQuestionModel,
      AssessmentQuestionModel
    >
