...
class AssessmentQuestionAnswerModelMapper
  ...
  static AssessmentQuestionAnswerModelMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AssessmentQuestionAnswerModelMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<AssessmentQuestionAnswerModel, String> _f$answerId = Field(
    'answerId',
    _$answerId,
    key: r'answer_id',
  );
...
mixin AssessmentQuestionAnswerModelMappable {
  ...
  bool operator ==(Object other) {
    return AssessmentQuestionAnswerModelMapper.ensureInitialized().equalsValue(
      this as AssessmentQuestionAnswerModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AssessmentQuestionAnswerModelMapper.ensureInitialized().hashValue(
      this as AssessmentQuestionAnswerModel,
    );
  }
}
