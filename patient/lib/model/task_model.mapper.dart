...
class PatientTaskModelMapper extends ClassMapperBase<PatientTaskModel> {
  ...
  static const Field<PatientTaskModel, String> _f$activityId = Field(
    'activityId',
    _$activityId,
    key: r'id',
    opt: true,
  ...
  static const Field<PatientTaskModel, String> _f$activityName = Field(
    'activityName',
    _$activityName,
    key: r'activity',
    opt: true,
...
mixin PatientTaskModelMappable {
  ...
  get copyWith =>
      _PatientTaskModelCopyWithImpl<PatientTaskModel, PatientTaskModel>(
        this as PatientTaskModel,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PatientTaskModelMapper.ensureInitialized().stringifyValue(
      this as PatientTaskModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return PatientTaskModelMapper.ensureInitialized().equalsValue(
      this as PatientTaskModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PatientTaskModelMapper.ensureInitialized().hashValue(
      this as PatientTaskModel,
    );
  }
}
...
extension PatientTaskModelValueCopy<$R, $Out>
  ...
  get $asPatientTaskModel =>
      $base.as((v, t, t2) => _PatientTaskModelCopyWithImpl<$R, $Out>(v, t, t2));
}
