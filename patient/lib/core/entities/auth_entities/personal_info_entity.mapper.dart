...
class PersonalInfoEntityMapper extends ClassMapperBase<PersonalInfoEntity> {
  ...
  static const Field<PersonalInfoEntity, String> _f$patientId = Field(
    'patientId',
    _$patientId,
    key: r'id',
  );
  static String _$patientName(PersonalInfoEntity v) => v.patientName;
  static const Field<PersonalInfoEntity, String> _f$patientName = Field(
    'patientName',
    _$patientName,
    key: r'patient_name',
  );
  ...
  static const Field<PersonalInfoEntity, bool> _f$isAdult = Field(
    'isAdult',
    _$isAdult,
    key: r'is_adult',
  );
  static String _$phoneNo(PersonalInfoEntity v) => v.phoneNo;
  static const Field<PersonalInfoEntity, String> _f$phoneNo = Field(
    'phoneNo',
    _$phoneNo,
    key: r'phone',
  );
  static String _$email(PersonalInfoEntity v) => v.email;
  static const Field<PersonalInfoEntity, String> _f$email = Field(
    'email',
    _$email,
  );
  static String? _$guardianName(PersonalInfoEntity v) => v.guardianName;
  static const Field<PersonalInfoEntity, String> _f$guardianName = Field(
    'guardianName',
    _$guardianName,
    key: r'guardian_name',
    opt: true,
  ...
  static const Field<PersonalInfoEntity, String> _f$country = Field(
    'country',
    _$country,
    opt: true,
  );
  static String? _$gender(PersonalInfoEntity v) => v.gender;
  static const Field<PersonalInfoEntity, String> _f$gender = Field(
    'gender',
    _$gender,
    opt: true,
  );
...
mixin PersonalInfoEntityMappable {
  ...
  PersonalInfoEntityCopyWith<
    PersonalInfoEntity,
    PersonalInfoEntity,
    PersonalInfoEntity
  >
  get copyWith =>
      _PersonalInfoEntityCopyWithImpl<PersonalInfoEntity, PersonalInfoEntity>(
        this as PersonalInfoEntity,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PersonalInfoEntityMapper.ensureInitialized().stringifyValue(
      this as PersonalInfoEntity,
    );
  }
  ...
  bool operator ==(Object other) {
    return PersonalInfoEntityMapper.ensureInitialized().equalsValue(
      this as PersonalInfoEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PersonalInfoEntityMapper.ensureInitialized().hashValue(
      this as PersonalInfoEntity,
    );
  }
}
...
abstract class PersonalInfoEntityCopyWith<
  $R,
  $In extends PersonalInfoEntity,
  $Out
>
