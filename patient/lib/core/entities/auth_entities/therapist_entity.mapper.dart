...
class TherapistEntityMapper extends ClassMapperBase<TherapistEntity> {
  ...
  static const Field<TherapistEntity, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  ...
  static const Field<TherapistEntity, String> _f$email = Field(
    'email',
    _$email,
  );
  static String _$phone(TherapistEntity v) => v.phone;
  static const Field<TherapistEntity, String> _f$phone = Field(
    'phone',
    _$phone,
  );
  static String _$clinicId(TherapistEntity v) => v.clinicId;
  static const Field<TherapistEntity, String> _f$clinicId = Field(
    'clinicId',
    _$clinicId,
    key: r'clinic_id',
  );
  static bool _$approved(TherapistEntity v) => v.approved;
  static const Field<TherapistEntity, bool> _f$approved = Field(
    'approved',
    _$approved,
  );
  static String _$specialisation(TherapistEntity v) => v.specialisation;
  static const Field<TherapistEntity, String> _f$specialisation = Field(
    'specialisation',
    _$specialisation,
  );
  static String _$gender(TherapistEntity v) => v.gender;
  static const Field<TherapistEntity, String> _f$gender = Field(
    'gender',
    _$gender,
  );
  static List<String> _$offeredTherapies(TherapistEntity v) =>
      v.offeredTherapies;
  static const Field<TherapistEntity, List<String>> _f$offeredTherapies = Field(
    'offeredTherapies',
    _$offeredTherapies,
    key: r'offered_therapies',
  );
  ...
  static const Field<TherapistEntity, String> _f$regulatoryBody = Field(
    'regulatoryBody',
    _$regulatoryBody,
    key: r'regulatory_body',
  );
...
mixin TherapistEntityMappable {
  ...
  Map<String, dynamic> toMap() {
    return TherapistEntityMapper.ensureInitialized().encodeMap<TherapistEntity>(
      this as TherapistEntity,
    );
  }
  ...
  @override
  String toString() {
    return TherapistEntityMapper.ensureInitialized().stringifyValue(
      this as TherapistEntity,
    );
  }
  ...
  bool operator ==(Object other) {
    return TherapistEntityMapper.ensureInitialized().equalsValue(
      this as TherapistEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TherapistEntityMapper.ensureInitialized().hashValue(
      this as TherapistEntity,
    );
  }
}
...
class _TherapistEntityCopyWithImpl<$R, $Out>
  ...
  TherapistEntity $make(CopyWithData data) => TherapistEntity(
    ...
    offeredTherapies: data.get(#offeredTherapies, or: $value.offeredTherapies),
    age: data.get(#age, or: $value.age),
    regulatoryBody: data.get(#regulatoryBody, or: $value.regulatoryBody),
    startAvailabilityTime: data.get(
      #startAvailabilityTime,
      or: $value.startAvailabilityTime,
    ),
    endAvailabilityTime: data.get(
      #endAvailabilityTime,
      or: $value.endAvailabilityTime,
    ),
  );
