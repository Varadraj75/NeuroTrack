...
class AssessmentQuestionEntityMapper
  ...
  static AssessmentQuestionEntityMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AssessmentQuestionEntityMapper._(),
      );
  ...
  static const Field<AssessmentQuestionEntity, String> _f$questionId = Field(
    'questionId',
    _$questionId,
    key: r'question_id',
  );
  static String _$text(AssessmentQuestionEntity v) => v.text;
  static const Field<AssessmentQuestionEntity, String> _f$text = Field(
    'text',
    _$text,
  );
...
mixin AssessmentQuestionEntityMappable {
  ...
  >
  get copyWith =>
      _AssessmentQuestionEntityCopyWithImpl<
        AssessmentQuestionEntity,
        AssessmentQuestionEntity
      >(this as AssessmentQuestionEntity, $identity, $identity);
  @override
  String toString() {
    return AssessmentQuestionEntityMapper.ensureInitialized().stringifyValue(
      this as AssessmentQuestionEntity,
    );
  }

  @override
  bool operator ==(Object other) {
    return AssessmentQuestionEntityMapper.ensureInitialized().equalsValue(
      this as AssessmentQuestionEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AssessmentQuestionEntityMapper.ensureInitialized().hashValue(
      this as AssessmentQuestionEntity,
    );
  }
}
...
extension AssessmentQuestionEntityValueCopy<$R, $Out>
  ...
  get $asAssessmentQuestionEntity => $base.as(
    (v, t, t2) => _AssessmentQuestionEntityCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _AssessmentQuestionEntityCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _AssessmentQuestionEntityCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
