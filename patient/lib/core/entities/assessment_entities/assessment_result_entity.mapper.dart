...
class AssessmentResultEntityMapper
  ...
  static const Field<AssessmentResultEntity, int> _f$assessmentScore = Field(
    'assessmentScore',
    _$assessmentScore,
    key: r'assessment_score',
  );
  static bool _$isAutistic(AssessmentResultEntity v) => v.isAutistic;
  static const Field<AssessmentResultEntity, bool> _f$isAutistic = Field(
    'isAutistic',
    _$isAutistic,
    key: r'is_autistic',
  );
  static String _$message(AssessmentResultEntity v) => v.message;
  static const Field<AssessmentResultEntity, String> _f$message = Field(
    'message',
    _$message,
  );
...
mixin AssessmentResultEntityMappable {
  ...
  AssessmentResultEntityCopyWith<
    AssessmentResultEntity,
    AssessmentResultEntity,
    AssessmentResultEntity
  >
  get copyWith =>
      _AssessmentResultEntityCopyWithImpl<
        AssessmentResultEntity,
        AssessmentResultEntity
      >(this as AssessmentResultEntity, $identity, $identity);
  @override
  String toString() {
    return AssessmentResultEntityMapper.ensureInitialized().stringifyValue(
      this as AssessmentResultEntity,
    );
  }

  @override
  bool operator ==(Object other) {
    return AssessmentResultEntityMapper.ensureInitialized().equalsValue(
      this as AssessmentResultEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AssessmentResultEntityMapper.ensureInitialized().hashValue(
      this as AssessmentResultEntity,
    );
  }
}
...
extension AssessmentResultEntityValueCopy<$R, $Out>
  ...
  get $asAssessmentResultEntity => $base.as(
    (v, t, t2) => _AssessmentResultEntityCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _AssessmentResultEntityCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _AssessmentResultEntityCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
