  ...
  static AssessmentQuestionAnswerEntityMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = AssessmentQuestionAnswerEntityMapper._(),
      );
    }
    return _instance!;
  }
...
mixin AssessmentQuestionAnswerEntityMappable {
  ...
  bool operator ==(Object other) {
    return AssessmentQuestionAnswerEntityMapper.ensureInitialized().equalsValue(
      this as AssessmentQuestionAnswerEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AssessmentQuestionAnswerEntityMapper.ensureInitialized().hashValue(
      this as AssessmentQuestionAnswerEntity,
    );
  }
}
...
extension AssessmentQuestionAnswerEntityValueCopy<$R, $Out>
  ...
  get $asAssessmentQuestionAnswerEntity => $base.as(
    (v, t, t2) =>
        _AssessmentQuestionAnswerEntityCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _AssessmentQuestionAnswerEntityCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? questionId, String? answerId}) => $apply(
    FieldCopyWithData({
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _AssessmentQuestionAnswerEntityCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
