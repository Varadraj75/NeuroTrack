...
class AssessmentEntityMapper extends ClassMapperBase<AssessmentEntity> {
  ...
  static const Field<AssessmentEntity, String> _f$assessmentId = Field(
    'assessmentId',
    _$assessmentId,
    key: r'id',
  );
  static String _$createdAt(AssessmentEntity v) => v.createdAt;
  static const Field<AssessmentEntity, String> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  ...
  static const Field<AssessmentEntity, String> _f$description = Field(
    'description',
    _$description,
  );
  static String _$category(AssessmentEntity v) => v.category;
  static const Field<AssessmentEntity, String> _f$category = Field(
    'category',
    _$category,
  );
  static int _$cutoffScore(AssessmentEntity v) => v.cutoffScore;
  static const Field<AssessmentEntity, int> _f$cutoffScore = Field(
    'cutoffScore',
    _$cutoffScore,
    key: r'cutoff_score',
  );
  static String _$imageUrl(AssessmentEntity v) => v.imageUrl;
  static const Field<AssessmentEntity, String> _f$imageUrl = Field(
    'imageUrl',
    _$imageUrl,
    key: r'image_url',
  );
...
mixin AssessmentEntityMappable {
  ...
  get copyWith =>
      _AssessmentEntityCopyWithImpl<AssessmentEntity, AssessmentEntity>(
        this as AssessmentEntity,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return AssessmentEntityMapper.ensureInitialized().stringifyValue(
      this as AssessmentEntity,
    );
  }
  ...
  bool operator ==(Object other) {
    return AssessmentEntityMapper.ensureInitialized().equalsValue(
      this as AssessmentEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AssessmentEntityMapper.ensureInitialized().hashValue(
      this as AssessmentEntity,
    );
  }
}
...
extension AssessmentEntityValueCopy<$R, $Out>
  ...
  get $asAssessmentEntity =>
      $base.as((v, t, t2) => _AssessmentEntityCopyWithImpl<$R, $Out>(v, t, t2));
}
...
abstract class AssessmentEntityCopyWith<$R, $In extends AssessmentEntity, $Out>
  ...
  ListCopyWith<
    ...
    AssessmentQuestionEntityCopyWith<
      $R,
      AssessmentQuestionEntity,
      AssessmentQuestionEntity
    >
