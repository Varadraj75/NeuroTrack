...
class AssessmentOptionEntityMapper
  ...
  static const Field<AssessmentOptionEntity, String> _f$optionId = Field(
    'optionId',
    _$optionId,
    key: r'option_id',
  );
  static String _$text(AssessmentOptionEntity v) => v.text;
  static const Field<AssessmentOptionEntity, String> _f$text = Field(
    'text',
    _$text,
  );
  static int _$score(AssessmentOptionEntity v) => v.score;
  static const Field<AssessmentOptionEntity, int> _f$score = Field(
    'score',
    _$score,
  );
...
mixin AssessmentOptionEntityMappable {
  ...
  >
  get copyWith =>
      _AssessmentOptionEntityCopyWithImpl<
        AssessmentOptionEntity,
        AssessmentOptionEntity
      >(this as AssessmentOptionEntity, $identity, $identity);
  @override
  String toString() {
    return AssessmentOptionEntityMapper.ensureInitialized().stringifyValue(
      this as AssessmentOptionEntity,
    );
  }

  @override
  bool operator ==(Object other) {
    return AssessmentOptionEntityMapper.ensureInitialized().equalsValue(
      this as AssessmentOptionEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AssessmentOptionEntityMapper.ensureInitialized().hashValue(
      this as AssessmentOptionEntity,
    );
  }
}
...
extension AssessmentOptionEntityValueCopy<$R, $Out>
  ...
  get $asAssessmentOptionEntity => $base.as(
    (v, t, t2) => _AssessmentOptionEntityCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
