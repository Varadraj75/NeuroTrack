...
class PatientTaskEntityMapper extends ClassMapperBase<PatientTaskEntity> {
  ...
  static const Field<PatientTaskEntity, String> _f$title = Field(
    'title',
    _$title,
  );
  static bool _$isCompleted(PatientTaskEntity v) => v.isCompleted;
  static const Field<PatientTaskEntity, bool> _f$isCompleted = Field(
    'isCompleted',
    _$isCompleted,
    key: r'is_completed',
  );
  static DateTime _$date(PatientTaskEntity v) => v.date;
  static const Field<PatientTaskEntity, DateTime> _f$date = Field(
    'date',
    _$date,
    key: r'date_assigned',
  );
...
mixin PatientTaskEntityMappable {
  ...
  get copyWith =>
      _PatientTaskEntityCopyWithImpl<PatientTaskEntity, PatientTaskEntity>(
        this as PatientTaskEntity,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PatientTaskEntityMapper.ensureInitialized().stringifyValue(
      this as PatientTaskEntity,
    );
  }
  ...
  bool operator ==(Object other) {
    return PatientTaskEntityMapper.ensureInitialized().equalsValue(
      this as PatientTaskEntity,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PatientTaskEntityMapper.ensureInitialized().hashValue(
      this as PatientTaskEntity,
    );
  }
}
...
extension PatientTaskEntityValueCopy<$R, $Out>
  ...
  get $asPatientTaskEntity => $base.as(
    (v, t, t2) => _PatientTaskEntityCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class PatientTaskEntityCopyWith<
  $R,
  $In extends PatientTaskEntity,
  $Out
>
...
class _PatientTaskEntityCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? title, bool? isCompleted, DateTime? date}) => $apply(
    FieldCopyWithData({
